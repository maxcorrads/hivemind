...
export function buildBrainPrompt(trial, fixture, workerCount) {
  ...
  return [
    ...
    'You are directly authorized by Human to execute the benchmark runbook below.',
    'Do not compute task hashes yourself: coordinate workers, assign structured tasks, collect their results, review them, and request changes when evidence is wrong.',
