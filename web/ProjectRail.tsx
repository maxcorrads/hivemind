...
/** The narrow column of project icons: one per project, with unread and mention marks. */
export function ProjectRail({ snap, selectedProject, onSelect, onNewProject }: {
  snap: Snapshot;
